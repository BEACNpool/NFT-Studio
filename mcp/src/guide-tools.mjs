...
export const GUIDE_INSTRUCTIONS =
  "For the visual CIP utility library or a build plan, use studio_workbench, get_utility_recipe and plan_nft_utility. Plans describe work and enable no benefit. " +
