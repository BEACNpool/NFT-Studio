...
- [Implementation evidence register](../knowledge/IMPLEMENTATIONS.md) — seven published implementations with separate capability environments, limitations and immutable source links. The browser joins these records to related research entries.
